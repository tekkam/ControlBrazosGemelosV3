...
Servo Palma1;
Servo Pinza1;
const byte PinHombro1 = 5;
const byte PinDeltoide1 = 6;
const byte PinCodo1 = 7;
const byte PinMuneca1 = 12;
const byte PinPalma1 = 12;
const byte PinPinza1 = 12;
Servo Hombro2;
Servo Deltoide2;
Servo Codo2;
Servo Muneca2;
Servo Palma2;
Servo Pinza2;
const byte PinHombro2 = 12;
const byte PinDeltoide2 = 12;
const byte PinCodo2 = 12;
const byte PinMuneca2 = 12;
const byte PinPalma2 = 12;
const byte PinPinza2 = 12;
...
*/
const int Frec_B_MG996 = 750; //560; //Frecuencia Baja para ángulo inferior Servo MG-996
const int Frec_A_MG996 = 2690; //2100; //Frecuencia Alta para ángulo superior Servo MG-996
